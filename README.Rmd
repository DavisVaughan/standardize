...
df[1, drop = FALSE]
```
It also helps with more complex array subsetting. In this casee, you also need to count higher dimensional subsetting in the `...`. Again, implicit dimensions should be returned as `NULL` to imply that they were counted but are missing.
